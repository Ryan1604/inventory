            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" action="<?php echo site_url('superadmin/barang_keluar/store') ?>" novalidate="">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectric" id="ket" name="ket">
                                        ...
                                        <option value="Pembuangan">Pembuangan Barang Rusak</option>
                                    </select>
                                </div>
                                <div class="form-group">
